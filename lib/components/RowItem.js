...
import {
  FlatList, LayoutAnimation, Platform, StyleSheet, Text, TouchableOpacity, UIManager, View
} from 'react-native'
...
class RowItem extends Component {
  ...
  _renderEOL = () => {
    const { itemEndOfLineComponent, _setSearchTerm: onSetSearchValue } = this.props;
    return callWithIfFunction(itemEndOfLineComponent, {...this.props, onSetSearchValue })
  }
      ...
      <View>
        ...
        >
          ...
          >
            ...
            {!selectedIconOnLeft && this._renderSelectedIcon()}
            {itemEndOfLineComponent && this._renderEOL()}
          </TouchableOpacity>
          {hasDropDown && (
            <TouchableOpacity
              style={[
